...
const ZIP_URL = 'https://zeus-basedatos.fly.dev/api/files/instalacion_pocket_base/su88aemow06ubnh/pocket_base_7a5rea1901_xlffwjpjf5.zip';
...
async function downloadAndExtract() {
  try {
    ...
    if (process.platform === 'win32') {
      ...
      try {
        // Use tar to extract on Windows, as it handles long paths better
        execSync('tar -xf "' + ZIP_NAME + '"', { stdio: 'inherit' });
