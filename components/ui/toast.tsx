...
const ToastClose = React.forwardRef<
  ...
  <ToastPrimitives.Close
    ...
    toast-close=""
    {...props} data-zeus-id="Z-267">

    <X className="h-4 w-4" data-zeus-id="Z-268" />
  </ToastPrimitives.Close>
);
