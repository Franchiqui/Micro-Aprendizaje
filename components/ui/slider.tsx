...
const Slider = React.forwardRef<
  ...
  <SliderPrimitive.Root
    ...
    {...props} data-zeus-id="Z-257">

    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-secondary" data-zeus-id="Z-258">
      <SliderPrimitive.Range className="absolute h-full bg-primary" data-zeus-id="Z-259" />
